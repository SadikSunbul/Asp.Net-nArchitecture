...
using ViabelliWebProject.Packages.Core.Security.Hashing;
...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(u => u.Mail).HasColumnName("Email").IsRequired();
        ...
        builder.Property(u => u.CreateDate).HasColumnName("CreatedDate").IsRequired();
        builder.Property(u => u.CreateDate).HasColumnName("UpdatedDate");
        ...
        builder.HasMany(u => u.EmailAuthentictors);
